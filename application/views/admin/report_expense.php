<div id="center-column">
  <div class="table">
    ...
    <?php echo form_open('report/expense_report'); ?>
    <table class="listing form" cellpadding="0" cellspacing="0">
      <tr>
        <th class="full" colspan="2" style="text-align: center;">Select Date for View Credit/Expense Report</th>
      </tr>
      <tr>
        <td class="first" width="120"><strong>Start Date</strong></td>
        <td class="last"><input type="text" name="sdate" class="date-pick" readonly /></td>
      </tr>
      <tr class="bg">
        <td class="first" width="120"><strong>End Date</strong></td>
        <td class="last"><input type="text" name="edate" class="date-pick" readonly /></td>
      </tr>
      <tr>
