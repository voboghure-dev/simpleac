  ...
  <div class="table">
    ...
    <table class="listing form" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td class="last"><input type="text" name="name" class="text" value="<?php echo $employee['name']; ?>" /></td>
      </tr>
      <tr class="bg">
        <td class="first" width="120" valign="top"><b>Address</b></td>
        <td class="last"><textarea name="address" style="width: 263px;"><?php echo $employee['address']; ?></textarea></td>
      </tr>
      <tr>
        <td class="first" width="120" valign="top"><b>Cell No</b></td>
        <td class="last"><input type="text" name="cell_no" class="text" value="<?php echo $employee['cell_no']; ?>" /></td>
      </tr>
      <tr class="bg">
        <td class="first" width="120" valign="top"><b>Date of Join</b></td>
        <td class="last"><input type="text"name="doj" class="text" value="<?php echo $employee['doj']; ?>" /> [ yyyy-mm-dd ]</td>
      </tr>
      <tr>
        <td class="first" width="120" valign="top"><b>Date of Birth</b></td>
        <td class="last"><input type="text" name="dob" class="text" value="<?php echo $employee['dob']; ?>" /> [ yyyy-mm-dd ]</td>
      </tr>
      <tr class="bg">
      ...
      <tr>
        <td class="full" colspan="2" style="text-align: center;">
          <?php echo form_submit('submit', 'Save Employee'); ?>
        </td>
      </tr>
    </table>
