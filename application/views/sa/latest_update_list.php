<div id="center-column">
  ...
  <div class="table">
    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      <tr>
        <th class="first" width="200">Title</th>
        <th>Entry Date</th>
        <th>Details</th>
      ...
      <tr <?php if($i==1){echo 'class="bg"';} ?>>
        ...
        <td><a href="<?php echo base_url(); ?>sa/latest_update/edit/<?php echo $value['id']; ?>"><img src="<?php echo base_url(); ?>images/edit-icon.gif" width="16" height="16" alt="edit" /></a></td>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
         type: "POST",
         url: "<?php echo base_url(); ?>sa/latest_update/delete",
